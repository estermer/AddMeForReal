...
app.get('/oauth/ig', function (req, res) {
  ...
  form.append('redirect_uri','https://getaddme.herokuapp.com/oauth/ig')
...
app.get('/oauth/fb', function (req, res) {
    https.get('https://graph.facebook.com/v2.3/oauth/access_token?client_id=134558940334255&redirect_uri=https://getaddme.herokuapp.com/oauth/fb&client_secret=e485181d992009910034bbda611eda66&code=' + req.query.code, (response) => {
...
app.get('/oauth/gh', function (req, res) {
    ...
    https.get('https://github.com/login/oauth/access_token?client_id=89221658f77bf282f490&client_secret=11f6d9c96c884834e4d3c4cfc0b8cd5c32231c52&code=' + req.query.code + '&redirect_uri=https://getaddme.herokuapp.com/oauth/gh', (response) => {
...
app.get('/:friend_id/addme', function(req, res) {
